...
START
	...
	JP PLAY
	JR MUTE
SETUP	DB 32 ;set bit0, if you want to play without looping
	     ;(optional);
...
;Identifier
	IF Id
	DB "=UniPT2/PT3/TS-Player r.",Release,"=","NextBuildv"
	ENDIF
...
; PD_RES	DI 			; we need to DI around STACK abuse! 
	; LD (PDSP_+1),SP
	; LD SP,IX
	; LD H,A
	; LD L,A
...
T_PACK	DB #06EC*2/256,0xd8 ;#06ec*2
	DB #0755-#06EC
	DB #07C5-#0755
	DB #083B-#07C5
	DB #08B8-#083B
...
progend 
	...
	savebin "ts4000.bin",MainProg,progend-MainProg